...
namespace ticketing{
    class Program{
        static void Main(string[] args){
            ...
            int men = 0;
            men = Convert.ToInt16( Console.ReadLine() );
            ...
            switch (men){
                ...
                case 3:
                    ...
                    break;
                default :
                    Console.WriteLine("akljdlkjasdjk");
                    break;
            }
        }

        private static void bookEvents(){
            // bookEvent[] booking = new bookEvent[1];
            // string eName, ePrice;

            // for(int i=0; i<booking.Length; i++){

            //     booking[i] = new bookEvent();

            //     Console.WriteLine("Masukkan nama event : ");
            //     eName = Console.ReadLine();

            //     Console.WriteLine("Masukkan harga tiket : ");
            //     ePrice = Console.ReadLine();

            //     booking[i].setEvent(eName, ePrice);

            //     // Console.WriteLine("================");
            //     // Console.WriteLine(booking[i].getEvent());
